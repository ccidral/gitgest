...
<xsl:stylesheet version="2.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform"
    ...
    <xsl:template match="repository">
        <h1 style="font-size: 1.2em;color: #555;margin:1em 0 0.3em 0;padding:1em 0 0 0;border-top:1px solid #ccc;">
    ...
    <xsl:template match="branch">
        <p>
            <span style="font-family:Monaco,'Lucida Console',monospace;display:inline-block;background-color:#0c0;color:white;padding:0.2em 0.5em;border-radius:0.3em;">
                &#8611;
                <xsl:value-of select="@name"/>
            </span>
        </p>
        ...
        <tr>
            ...
            <td style="vertical-align:top;width:9em;">
                ...
                <span style="color:#999;">
                    <xsl:value-of select="format-dateTime($dt, '[D01]/[M01]/[Y0001] [H01]:[m01]')"/>
                </span>
                <span>&nbsp;</span>
            </td>
            <td style="vertical-align:top;">
                <span style="color:#66e;">
            ...
            <td style="vertical-align:top;">
                <xsl:if test="refdesc != ''">
                    <span style="display:inline-block;background-color:#f77;color:white;font-size:0.7em;padding:0.2em 0.3em;border-radius:0.2em;font-family:Monaco,'Lucida Console',monospace;">
